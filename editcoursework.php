...
<br><select name="speciality" id="charstype" disabled="disabled">
    ...
    <div>
       ...
       <option value = "6">6</option>
                                    ...
                                    <div>
                                        <label> Опис<br><textarea class="form-control" name="content" required rows="20" cols="100%"> </textarea>
                    </label>
                                    </div>
                                    ...
                                    <a href="#"><button type="button" class="btn btn-success">Додати</button></a>
