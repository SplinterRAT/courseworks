function checkSizeWindow(){
	...
	$.getJSON('js/photo.json', function(data) {
...
$(".modal-body").html('<div align="center"><iframe width="700" height="500" src="https://www.youtube.com/embed/97QJWnmtf54?autoplay=1" frameborder="0" allowfullscreen></iframe></div>');   
    $("#myModal").modal('show');
});
